      ...
      <div className="container-section relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium font-inter tracking-wide">Grassroots Research, Real-World Impact</span>
          </motion.div>
          ...
          >
            From <span className="text-[#EA384C] font-extrabold">Ignorance</span> to <span className="text-[#6936F5] font-extrabold">Insight</span>
          </motion.h1>
